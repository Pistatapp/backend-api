...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\LabourAttendanceSession>
 */
class LabourAttendanceSessionFactory extends Factory
{
    /**
     ...
     * @var string
     */
    protected $model = LabourAttendanceSession::class;
