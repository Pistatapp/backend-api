...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\WorkerGpsData>
 */
class WorkerGpsDataFactory extends Factory
{
    /**
     ...
     * @var string
     */
    protected $model = WorkerGpsData::class;
