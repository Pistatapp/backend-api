...
Route::middleware(['auth:sanctum', 'last.activity', 'ensure.username'])->group(function () {
    ...
    Route::get('/tractors/{tractor}/current-task', [ActiveTractorController::class, 'getCurrentTask']);
    ...
    Route::get('/plots/{plot}/irrigations/report', [IrrigationController::class, 'getIrrigationReportForPlot']);
