...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'REST API for the Pistat farm management application. Documentation is generated automatically from routes, form requests, and API resources.',
    ],
    ...
    'renderers' => [
        ...
        'scalar' => [
            ...
            'theme' => 'laravel',
            'proxyUrl' => env('SCRAMBLE_PROXY_URL'),
            'darkMode' => false,
