...
class ParseDataServiceTest extends TestCase
{
    ...
    {
        $data = json_encode([
            ['data' => '+Hooshnic:V1.03,3453.04393,05035.9775,000,240421,070200,018,000,1,863070043386100']
        ]);
    ...
    public function it_filters_out_old_dates()
    {
        ...
        $data = json_encode([
            ['data' => '+Hooshnic:V1.03,3453.04393,05035.9775,000,240321,070200,018,000,1,863070043386100'],
            ['data' => '+Hooshnic:V1.03,3453.04393,05035.9775,000,240421,070200,018,000,1,863070043386100']
        ]);
    ...
    public function it_sorts_results_by_datetime()
    {
        $data = json_encode([
            ['data' => '+Hooshnic:V1.03,3453.04393,05035.9775,000,240421,070200,018,000,1,863070043386100'],
            ['data' => '+Hooshnic:V1.03,3453.04393,05035.9775,000,240421,070100,018,000,1,863070043386100']
        ]);
    ...
    public function it_correctly_parses_and_sorts_multiple_gps_data()
    {
        ...
        $data = '[
            {"data":"+Hooshnic:V1.03,3453.04393,05035.9775,000,240421,070900,000,000,1,863070043386100"}
            {"data":"+Hooshnic:V1.03,3453.04393,05035.9775,000,240421,070800,000,000,1,863070043386100"}
            {"data":"+Hooshnic:V1.03,3453.04393,05035.9775,000,240421,070700,000,000,1,863070043386100"}
            {"data":"+Hooshnic:V1.03,3453.04393,05035.9775,000,240421,070600,000,000,1,863070043386100"}
            {"data":"+Hooshnic:V1.03,3453.04393,05035.9775,000,240421,070500,018,000,1,863070043386100"}
            {"data":"+Hooshnic:V1.03,3453.04393,05035.9775,000,240421,070400,005,000,1,863070043386100"}
            {"data":"+Hooshnic:V1.03,3453.04393,05035.9775,000,240421,070300,015,000,1,863070043386100"}
            {"data":"+Hooshnic:V1.03,3453.04393,05035.9775,000,240421,070200,000,000,1,863070043386100"}
            {"data":"+Hooshnic:V1.03,3453.04393,05035.9775,000,240421,070100,000,000,0,863070043386100"}
            {"data":"+Hooshnic:V1.03,3453.04393,05035.9775,000,240421,070000,000,000,0,863070043386100"}
        ]';
