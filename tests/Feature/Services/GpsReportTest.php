...
class GpsReportTest extends TestCase
{
    ...
    public function it_processes_gps_report_and_broadcasts_events()
    {
        ...
        $jsonData = [
            ['data' => '+Hooshnic:V1.03,3453.04393,05035.9775,000,240124,070200,018,000,1,090,0,863070043386100']
        ];
    ...
    {
        $jsonData = [
            ['data' => '+Hooshnic:V1.03,3453.04393,05035.9775,000,240124,070000,000,000,1,090,0,863070043386100'],
            ['data' => '+Hooshnic:V1.03,3453.04393,05035.9775,000,240124,070100,020,000,1,180,0,863070043386100'],
            ['data' => '+Hooshnic:V1.03,3453.04394,05035.9776,000,240124,070200,000,000,1,270,0,863070043386100']
        ];
    ...
    public function it_updates_existing_daily_report()
    {
        ...
        $this->postJson('/api/gps/reports', [
            ['data' => '+Hooshnic:V1.03,3453.04393,05035.9775,000,240124,070000,020,000,1,090,0,863070043386100']
        ]);
        ...
        // Second report
        $this->postJson('/api/gps/reports', [
            ['data' => '+Hooshnic:V1.03,3453.04394,05035.9776,000,240124,070100,020,000,1,180,0,863070043386100']
        ]);
    ...
    public function it_only_counts_reports_within_working_hours_when_no_task()
    {
        ...
        $this->postJson('/api/gps/reports', [
            ['data' => '+Hooshnic:V1.03,3453.04393,05035.9775,000,240124,060000,020,000,1,090,0,863070043386100']
        ]);
        ...
        $this->postJson('/api/gps/reports', [
            ['data' => '+Hooshnic:V1.03,3453.04394,05035.9776,000,240124,080000,020,000,1,180,0,863070043386100']
        ]);
