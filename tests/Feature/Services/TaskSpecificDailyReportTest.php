...
class TaskSpecificDailyReportTest extends TestCase
{
    ...
    public function it_creates_separate_daily_reports_for_different_tasks()
    {
        ...
        $this->postJson('/api/gps/reports', [[
            'data' => '+Hooshnic:V1.03,3453.04393,05035.9775,000,240124,070000,020,000,1,1,3,863070043386100'
        ]]);
        ...
        $this->postJson('/api/gps/reports', [[
            'data' => '+Hooshnic:V1.03,3453.04485,05035.9777,000,240124,110000,020,000,1,1,4,863070043386100'
        ]]);
    ...
    public function it_handles_gps_reports_outside_task_areas()
    {
        ...
        $this->postJson('/api/gps/reports', [[
            'data' => '+Hooshnic:V1.03,3553.05000,05135.9800,000,240124,070000,020,000,1,2,4,863070043386100'
        ]]);
    ...
    public function it_accumulates_metrics_separately_for_each_task()
    {
        ...
        $this->postJson('/api/gps/reports', [
            ['data' => '+Hooshnic:V1.03,3453.04393,05035.9775,000,240124,070000,015,000,1,1,3,863070043386100'],
            ['data' => '+Hooshnic:V1.03,3453.04394,05035.9776,000,240124,070100,015,000,1,1,3,863070043386100']
        ]);
        ...
        $this->postJson('/api/gps/reports', [
            ['data' => '+Hooshnic:V1.03,3453.06888,05035.9862,015,240124,143000,015,000,1,1,4,863070043386100'],
            ['data' => '+Hooshnic:V1.03,3453.06890,05035.9865,015,240124,143100,015,000,1,2,4,863070043386100']
        ]);
