...
class WorkerDailyReportApprovalService
{
    /**
     * Approve a daily report
     *
     * @param WorkerDailyReport $report
     * @param User $approver
     * @return void
     */
    public function approve(WorkerDailyReport $report, User $approver): void
    {
     ...
     * @return void
     */
    public function updateReport(WorkerDailyReport $report, array $data): void
    {
        $report->update([
